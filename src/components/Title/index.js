...
import React, { useMemo, useRef, useLayoutEffect, useEffect, useState, useCallback, useContext} from 'react'
// import { extend, useLoader } from '@react-three/fiber'
import { Text, useMatcapTexture, Octahedron, useGLTFLoader, FlyControls } from '@react-three/drei'
...
const {setBloomInit, setCurrentSection, bloomInit,setCurrentSubSection} = contextValue
  ...
  return (
    <group {...props} onClick={onClick} onPointerOver={onPointerOver} onPointerOut={onPointerOut}>
      <AnimatedText {...spring} name="text-olga" depthTest={false}  {...TEXT_PROPS}>
        HOT POTATO
